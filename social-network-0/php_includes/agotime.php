...
<!DOCTYPE html>
<head>
<title>ago time</title>
</head>
<body>
Published <time datetime="<?php echo date( 'Y-m-d', $time )?>" title="<?=strftime( date( 'Y', $time ) == date( 'Y' ) ? TIMEBEFORE_FORMAT : TIMEBEFORE_FORMAT_YEAR, $time )?>"> <? echo time_ago( $time )?> </time>
</body>
<script>
