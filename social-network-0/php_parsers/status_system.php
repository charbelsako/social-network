...
if (isset($_POST['action']) && $_POST['action'] == "delete_status"){
	...
	$query = mysqli_query($db_conx, "SELECT account_name, author, postdate FROM status WHERE id='$statusid' LIMIT 1");
    ...
    if ($author == $log_username || $account_name == $log_username) {
		mysqli_query($db_conx, "DELETE FROM notifications WHERE date_time='$date' AND initiator='$author'");
